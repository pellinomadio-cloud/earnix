      ...
      <div className="space-y-4">
        <div className="bg-gray-900 rounded-2xl p-5 shadow-sm border border-gray-800 space-y-4">
          ...
          <div className="space-y-3 pt-2">
              <button 
                  ...
                  className={`w-full py-3.5 rounded-xl font-bold shadow-lg transition-all flex items-center justify-center space-x-2 active:scale-95 ${canClaimTelegram() ? 'bg-gold text-black hover:bg-gold-dark' : 'bg-gray-800 text-gray-500 cursor-not-allowed'}`}
              >
                  <Icons.Send size={18} />
        ...
        <div className="bg-gray-900 rounded-2xl p-5 shadow-sm border border-gray-800 space-y-4">
          ...
          <div className="space-y-3 pt-2">
              <button 
                  onClick={() => {
                      window.open('https://t.me/earnix9', '_blank');
                      onTelegramClaim2();
                  }}
                  disabled={!canClaimTelegram2()}
                  className={`w-full py-3.5 rounded-xl font-bold shadow-lg transition-all flex items-center justify-center space-x-2 active:scale-95 ${canClaimTelegram2() ? 'bg-gold text-black hover:bg-gold-dark' : 'bg-gray-800 text-gray-500 cursor-not-allowed'}`}
              >
                  <Icons.Send size={18} />
