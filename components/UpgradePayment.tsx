...
const UpgradePayment: React.FC<UpgradePaymentProps> = ({ userEmail, onPaymentComplete }) => {
  ...
  const accountNumber = "6010822388";
  ...
  return (
    <div className="px-4 py-6 space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-10">
      ...
      <div className="bg-gray-900 p-4 rounded-xl flex justify-between items-center border border-gold shadow-sm">
        <div>
            <p className="text-xs text-gold font-bold uppercase tracking-wide">Selected Service</p>
            <h3 className="text-lg font-bold text-white">Lifetime VIP Membership</h3>
        </div>
        <div className="text-right">
            <p className="text-lg font-extrabold text-gold">₦15,000</p>
        ...
        <div className="bg-gray-900 rounded-2xl p-6 shadow-xl border border-gold/30 space-y-4 relative overflow-hidden">
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between items-center border-b border-gray-800 pb-2">
              ...
              <span className="text-lg font-black text-gold uppercase">BestStar MFB</span>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-xs text-gray-500 uppercase font-bold">Account Name</span>
              <span className="text-sm font-black text-white uppercase">EARNIX9JA - by oluwatosin</span>
            </div>
          </div>
